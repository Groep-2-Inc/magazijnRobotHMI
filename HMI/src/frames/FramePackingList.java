...
public class FramePackingList extends FrameHeader implements ActionListener {
    ...
    public FramePackingList(Order order) {
        ...
        jl_order.setBounds(getScreenWidth(getPercentage(1536, 100)), getScreenHeight(getPercentage(864, 5)), sizeOrder.width + getScreenWidth(getPercentage(1536, 10)), sizeOrder.height);
        ...
        jl_date.setBounds(getScreenWidth(getPercentage(1536, 250)), getScreenHeight(getPercentage(864, 5)), sizeDate.width + getScreenWidth(getPercentage(1536, 10)), sizeDate.height);
        ...
        jl_customer.setBounds(getScreenWidth(getPercentage(1536, 100)), getScreenHeight(getPercentage(864, 40)), sizeCustomer.width + getScreenWidth(getPercentage(1536, 10)), sizeCustomer.height);
        ...
        jl_box.setBounds(getScreenWidth(getPercentage(1536, 100)), getScreenHeight(getPercentage(864, 70)), sizeBox.width + getScreenWidth(getPercentage(1536, 10)), sizeBox.height);
        ...
        jp_productListPanel.setPreferredSize(new Dimension(getScreenWidth(getPercentage(1536, 1320)), getScreenHeight(getPercentage(864, 75)) * order.getProducts().size()));
        ...
        add(jsp_productList);
        jsp_productList.setBounds(getScreenWidth(getPercentage(1536, 100)), getScreenHeight(getPercentage(864, 100)), sizeProductListPanel.width + getScreenWidth(getPercentage(1536, 10)), getScreenHeight(getPercentage(864, 600)));
